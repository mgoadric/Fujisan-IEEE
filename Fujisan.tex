...
\IEEEPARstart{T}{ogelius} et al. \cite{SBPCG} describe a general taxonomy of dimensions for characterizing procedural content generation (PCG), where algorithms are used to create game content \cite{PCGSURVEY}. PCG can occur {\it offline} (beforehand) or {\it online} (dynamically during the game). The content can be {\it constructed}
